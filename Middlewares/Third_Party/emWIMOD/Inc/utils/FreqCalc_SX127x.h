//------------------------------------------------------------------------------
//! @file FreqCalc_SX127x.h
//! @ingroup Utils
//! <!------------------------------------------------------------------------->
//! @brief Helper Utility to calc frequency to transceiver register and vice versa for the SX127x transceiver series
//! @version 0.1
//! <!------------------------------------------------------------------------->
//!
...
#ifndef ARDUINO_UTILS_FREQCALC_SX127X_H_
#define ARDUINO_UTILS_FREQCALC_SX127X_H_
...
#endif /* ARDUINO_UTILS_FREQCALC_SX127X_H_ */
